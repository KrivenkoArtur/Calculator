...
class Calculator(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_backspace.clicked.connect(self.backspase)

        # math
        self.ui.btn_calc.clicked.connect(self.calculate)
        self.ui.btn_add.clicked.connect(lambda: self.math_operatioin('+'))
        self.ui.btn_sub.clicked.connect(lambda: self.math_operatioin('-'))
        self.ui.btn_mul.clicked.connect(lambda: self.math_operatioin('*'))
        self.ui.btn_div.clicked.connect(lambda: self.math_operatioin('/'))
    ...
    def math_operatioin(self, math_sign: str):
        temp = self.ui.lbl_temp.text()
